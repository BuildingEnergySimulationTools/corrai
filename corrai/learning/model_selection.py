...
def time_series_sampling(
    ...
    """
    Wraps keras timeseries_dataset_from_array to generate batches
    ...
    Parameters:
    :param X: Dataframe or 2D Array containing the data
    ...
    stacked = np.empty([0, sequence_length, n_features])
